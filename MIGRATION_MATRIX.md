...
| SenseVoice | `SenseVoiceTranscriptionEngine` | `recognizer.rs` | `IRecognizer` + sherpa 适配 | 已验证 | 官方中文音频与模型加载 |
...
| 更新检查 | `UpdateManager` | `update.rs` | WinHTTP updater | 待接入 | 固定 tag 与哈希 |
