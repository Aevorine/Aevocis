...
//!
//! Usage: `cargo run --example make_icon`. Only needs re-running if the source
//! artwork changes; the generated files are committed like any other asset.
...
const SOURCE_PNG: &str = r"D:\Documents\WorkDocuments\WorkDocuments_Configuration\Github_Configuration\Aevocis_Configuration\Aevocis\Aevocis.png";
