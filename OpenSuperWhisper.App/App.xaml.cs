...
public partial class App : Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        _controller = new DictationController(recorder, engine, injector, hotkey, historyStore, settings, termsStore, voiceCommandStore, macroStore);
        ...
        // transcript, so it doesn't touch history.
        _controller.CommandExecuted += _ => Dispatcher.Invoke(() =>
        {
            _trayIcon.ToolTipText = "超语音 - 就绪";
            _overlayHideFallbackTimer?.Stop();
            _overlayWindow!.HideOverlay();
    ...
    private void ShowSettingsWindow()
    {
        var window = new SettingsWindow(
            _settings!, _settingsStore!, _voiceCommandStore!, _macroStore!,
